...
$sql = "SELECT * FROM move WHERE movieID = '4' ";
...
<div class="bg-img">
  <div class="container header">
    ...
    <select name="date" required>
        ...
        <option value="20-11">November 20,2020</option>
        <option value="21-11">November 21,2020</option>
